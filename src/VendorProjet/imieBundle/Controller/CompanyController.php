...
use VendorProjet\imieBundle\Entity\Company;
use VendorProjet\imieBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VendorProjetimieBundle:Company')->findAll();
     ...
     * @Method("POST")
     * @Template("VendorProjetimieBundle:Company:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VendorProjetimieBundle:Company')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VendorProjetimieBundle:Company:edit.html.twig")
     */
