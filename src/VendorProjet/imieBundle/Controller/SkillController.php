...
use VendorProjet\imieBundle\Entity\Skill;
use VendorProjet\imieBundle\Form\SkillType;
...
class SkillController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VendorProjetimieBundle:Skill')->findAll();
     ...
     * @Method("POST")
     * @Template("VendorProjetimieBundle:Skill:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VendorProjetimieBundle:Skill')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VendorProjetimieBundle:Skill:edit.html.twig")
     */
