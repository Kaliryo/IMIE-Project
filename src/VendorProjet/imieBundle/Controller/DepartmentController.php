...
use VendorProjet\imieBundle\Entity\Department;
use VendorProjet\imieBundle\Form\DepartmentType;
...
class DepartmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VendorProjetimieBundle:Department')->findAll();
     ...
     * @Method("POST")
     * @Template("VendorProjetimieBundle:Department:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VendorProjetimieBundle:Department')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VendorProjetimieBundle:Department:edit.html.twig")
     */
